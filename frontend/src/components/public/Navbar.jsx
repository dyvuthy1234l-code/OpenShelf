          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4">
            ...
            <form onSubmit={handleSearchSubmit} className="relative w-48 xl:w-56">
              ...
              <input
                ...
                className="w-full bg-slate-100/80 border border-slate-200/80 focus:border-amber-500 rounded-xl py-2 pl-10 pr-4 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-amber-500/20 transition-all"
              />
            </form>
