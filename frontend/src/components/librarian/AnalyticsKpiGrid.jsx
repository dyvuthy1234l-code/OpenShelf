      ...
      {kpiData.map((kpi, idx) => {
        ...
        return (
          <motion.div
            key={idx}
            variants={LIST_ITEM}
            className={`bg-white border border-slate-200/90 rounded-2xl py-2 px-2.5 shadow-2xs hover:shadow-md ${kpi.borderHover} transition-all duration-200 flex flex-col justify-between h-[82px] group`}
          >
